...
def distance_matrix_calc(u, group1_positions, group2_positions, parallel="OpenMP"):
        ...
        distance_matrix = mda.lib.distances.distance_array(group1_positions, group2_positions, 
                                                           box=u.dimensions, backend=str(parallel))
...
def coord_matrix_calc(u, atom_name, polymer_oxygen_pos, water_positions, cut_off, parallel="OpenMP"):
        ...
        water_positions : np.array
            np.array with the positions of the water moieties. 


        cut_off : class.float
            number cut off of the distance between the polymer beads and the water for hydration 
            calculation.
        ...
        distance_matrix = mda.lib.distances.distance_array(polymer_oxygen_pos, water_positions, box= u.dimensions, backend=str(parallel))
