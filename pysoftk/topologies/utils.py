...
def pattern_repl(pattern, tup_repl):
   """Function to perform a pattern replacement using tuples generated by pattern and molecular names.
   ...
   return: list    
        Returns the names of the molecules as provided by the string pattern.
   """
...
def pattern_mol_seq(mols, pattern):
    """Function to create a list of molecules based on a user provided pattern.
    ...
    mols: list
        List containing the names of the molecules to form a polymer with a given pattern.

    Returns
    ---------

    return: list
      List with the correct sequence of molecular fragments to be merged. 
...
def count_plholder(mol, atom):
    """Function to count the number of user defined atomic placeholders.
